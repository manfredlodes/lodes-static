...
create_text_file "README.md" "# Travel Archive"
create_text_file "LICENSE" "License to be defined."
create_text_file ".gitignore" "# macOS
.DS_Store"
...
for entry in "${DOCUMENTS[@]}"; do
  ...
  create_markdown_file "$FILE" "$DOCUMENT" "$TITLE"
done
